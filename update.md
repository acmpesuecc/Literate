...
- **_THE FIX_** : filtered out only the fileID and then tried passing that into the mupdf viewer in the form of a url , and that worked , i didnt get random strings BUTTT...THE RESPONSE WAS NULL....(CHECK CONSOLE ALWAYS!!)
