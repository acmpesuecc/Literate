...
- **[Vite](https://vite.dev)**: Makes development faster and keeps the build process lightweight and efficient.
...
- **[OAuth 2.0](https://oauth.net/2/) (Google Authentication)**: Lets users sign in safely using their Google account without sharing passwords.
